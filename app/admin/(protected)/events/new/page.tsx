...
const fields = [
  ...
  { name: "sourceName", label: "Nombre del calendario / organización" },
  { name: "sourceLogoUrl", label: "Logo del calendario / organización", type: "image" },
  { name: "sourceCalendarUrl", label: "ID o URL del Google Calendar" },
