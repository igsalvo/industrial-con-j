...
export default async function AdminProductsPage() {
  ...
  if (!records) return <MvpPlaceholder eyebrow="Productos" title="Sección pendiente de migración" description="Aplica la migración de Prisma en la base de datos para crear y editar productos." />;
