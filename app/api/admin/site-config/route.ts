...
export async function PATCH(request: Request) {
  ...
  const siteConfigData = {
    ...
    showNewsSection: payload.showNewsSection === true,
    showAlumniNewsSection: payload.showAlumniNewsSection === true,
    ...
    heroVideoUrl,
    heroVideoPosterUrl: toNullableString(payload.heroVideoPosterUrl),
    heroVideoEnabled,
    ...
    newsSectionEyebrow: toNullableString(payload.newsSectionEyebrow),
    newsSectionTitle: toNullableString(payload.newsSectionTitle),
    newsSectionDescription: toNullableString(payload.newsSectionDescription),
    newsSectionOrder: toNumber(payload.newsSectionOrder, 4),
    alumniNewsSectionEyebrow: toNullableString(payload.alumniNewsSectionEyebrow),
    alumniNewsSectionTitle: toNullableString(payload.alumniNewsSectionTitle),
    alumniNewsSectionDescription: toNullableString(payload.alumniNewsSectionDescription),
    alumniNewsSectionOrder: toNumber(payload.alumniNewsSectionOrder, 8),
